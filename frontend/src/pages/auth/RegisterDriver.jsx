...
import { Eye, EyeOff, Mail, Lock, User, Phone, UserPlus, CreditCard, Calendar } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Registro de Chofer</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              {errors.licenseNumber && <p className="mt-1 text-sm text-error-600">{errors.licenseNumber.message}</p>}
            </div>
            ...
            <div>
              ...
              {errors.licenseExpiry && <p className="mt-1 text-sm text-error-600">{errors.licenseExpiry.message}</p>}
            </div>
            ...
            >
              {isSubmitting ? <LoadingSpinner size="sm" color="white" /> : <><UserPlus className="w-4 h-4" /><span>Crear cuenta de chofer</span></>}
            </button>
          </form>
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-xs text-gray-500 text-center">
              Al continuar con Google, tu cuenta se crea automáticamente como chofer.
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <Link to="/auth/login/driver" className="text-primary-600 hover:text-primary-500 font-medium">
