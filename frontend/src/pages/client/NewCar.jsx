          ...
          <div className="flex items-center py-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Agrega la información de tu vehículo para programar citas
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  El VIN se encuentra en el tablero del lado del conductor o en la puerta
                </p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-soft p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  Especifica el tamaño del motor si lo conoces
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-soft p-8">
            ...
            <p className="text-gray-600 mb-6">
              Sube los documentos de tu vehículo para agilizar el proceso de verificación.
            </p>
            ...
            <div className="mt-4 p-4 bg-info-50 border border-info-200 rounded-lg">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-info-900">Información importante</h4>
                  <p className="text-sm text-info-700 mt-1">
                    Los documentos son opcionales pero recomendados. Tener tus documentos actualizados 
                    agiliza el proceso de verificación y evita retrasos en tu cita.
                  </p>
                </div>
              </div>
            </div>
